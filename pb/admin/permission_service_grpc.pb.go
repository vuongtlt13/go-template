...
const (
	PermissionService_CreatePermission_FullMethodName = "/yourapp.admin.PermissionService/CreatePermission"
	PermissionService_GetPermission_FullMethodName    = "/yourapp.admin.PermissionService/GetPermission"
	PermissionService_UpdatePermission_FullMethodName = "/yourapp.admin.PermissionService/UpdatePermission"
	PermissionService_DeletePermission_FullMethodName = "/yourapp.admin.PermissionService/DeletePermission"
	PermissionService_ListPermissions_FullMethodName  = "/yourapp.admin.PermissionService/ListPermissions"
)
...
func (c *permissionServiceClient) GetPermission(ctx context.Context, in *GetPermissionRequest, opts ...grpc.CallOption) (*PermissionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PermissionResponse)
...
func (c *permissionServiceClient) UpdatePermission(ctx context.Context, in *UpdatePermissionRequest, opts ...grpc.CallOption) (*PermissionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PermissionResponse)
...
func (UnimplementedPermissionServiceServer) GetPermission(context.Context, *GetPermissionRequest) (*PermissionResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetPermission not implemented")
}
func (UnimplementedPermissionServiceServer) UpdatePermission(context.Context, *UpdatePermissionRequest) (*PermissionResponse, error) {
...
var PermissionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "yourapp.admin.PermissionService",
	...
	Metadata: "admin/permission_service.proto",
}
